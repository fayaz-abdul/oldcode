var BBCAppPortlet = YAHOO.zenoss.Subclass.create(YAHOO.zenoss.portlet.Portlet);

BBCAppPortlet.prototype = {
    __class__:"YAHOO.zenoss.portlet.BBCAppPortlet",
    __init__: function(args) {
        args = args || {};
        id = 'id' in args? args.id : getUID('BBCApp');
        title = 'title' in args? args.title: "BBC Applications";
...
YAHOO.zenoss.portlet.BBCAppPortlet = BBCAppPortlet;
